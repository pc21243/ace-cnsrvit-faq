...
const periodTypeSelect = new Choices(document.getElementById('grant_id'), {
    position: 'bottom',
    shouldSort: false,
    shouldSortItems: false,
    searchPlaceholderValue: "search...",
...
const payPeriodASelect = new Choices(document.getElementById('division_id'), {
    position: 'bottom',
    shouldSort: false,
    shouldSortItems: false,
    searchPlaceholderValue: "search...",
});
const payPeriodBSelect = new Choices(document.getElementById('program_id'), {
    position: 'bottom',
    shouldSort: false,
    shouldSortItems: false,
    searchPlaceholderValue: "search...",
...
const showSelectionTwo = (choices) => {
    ...
    switch (choices) {
    case "onboarding_not_in_payroll_system":
